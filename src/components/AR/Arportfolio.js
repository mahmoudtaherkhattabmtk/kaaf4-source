...
const Portfolio = () => {
  ...
  return (
    <div className="arContainer">
      <Arside />
      <div class="section arexp-section bounce-right">
        <h1 className="decore">أعمالنا.</h1>
        <h1>
          <i className="fa fa-address-card-o"> </i> أعمالنا 
        </h1>

        <div className="tabs">
          <div className="tab" onClick={() => filterGallery('all')}>الكل</div>
          <div className="tab" onClick={() => filterGallery('labs')}>المعامل</div>
          <div className="tab" onClick={() => filterGallery('projects')}>المشاريع</div>
          <div className="tab" onClick={() => filterGallery('ps')}>المهارات الشخصية</div>
          <div className="tab" onClick={() => filterGallery('ts')}>المهارات التقنية</div>
          <div className="tab" onClick={() => filterGallery('prs')}>المهارات العملية</div>
        </div>
